...
$Nav->write();
    ...
    if (($SBC->getSite() !== SiteCode::EN) && ($SBC->getSite() !== SiteCode::FR)) {
        ...
        echo(t(5) . '<a href="https://facebook.com/' . $strLink . '">Facebook</a>' . PHP_EOL);
                    echo(t(4) . '</div>' . PHP_EOL);
        ...
        $strLink = ($strLang === 'fr' ? 'fb' : 'fb');
                    ...
                    echo(t(4) . '</div>' . PHP_EOL);
                    echo(t(4) . '<div class="link_social">' . PHP_EOL);
        echo(t(5) . '<a href="https://insta.com/' . $strLink . '">Instagram</a>' . PHP_EOL);
                    echo(t(4) . '</div>' . PHP_EOL);
                echo(t(3) . '</div>' . PHP_EOP);
        ...
        $strLink = ($strLang === 'fr' ? 'fb' : 'fb');
                    ...
                    echo(t(4) . '</div>' . PHP_EOL);
                    echo(t(4) . '<div class="link_social">' . PHP_EOL);
        echo(t(5) . '<a href="https://mastodon.com/' . $strLink . '">Mastodon</a>' . PHP_EOL);
                    echo(t(4) . '</div>' . PHP_EOL);
                echo(t(3) . '</div>' . PHP_EOP);
        ...
        $strLink = ($strLang === 'fr' ? 'fb' : 'fb');
                    ...
                    echo(t(4) . '</div>' . PHP_EOL);
                    echo(t(4) . '<div class="link_social">' . PHP_EOL);
        echo(t(5) . '<a href="https://facebook.com/' . $strLink . '">Threads</a>' . PHP_EOL);
                    echo(t(4) . '</div>' . PHP_EOL);
                echo(t(3) . '</div>' . PHP_EOP);
